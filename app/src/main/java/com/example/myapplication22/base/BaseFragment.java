...
import com.example.myapplication22.di.component.DaggerFragmentComponent;
import com.example.myapplication22.di.component.FragmentComponent;
...
public abstract class BaseFragment<T extends BaseContrat.BasePresenter> extends RxFragment
        implements ISupportFragment, BaseContrat.BaseView {
     ...
     * @Nullable和NotNull的作用
     * @Nullable :可以传入null值
     * @NotNull ： 不可以传入null值，如果传了null，将会获得警告⚠️
     *
     */
    @Nullable
    @Inject
     ...
     * @param container
     */
    private void inflaterView(LayoutInflater inflater, @android.support.annotation.Nullable ViewGroup container) {
        if (mRootView == null) {
